									...
									<div class="header-top">
								            ...
								            <div class="col-md-6 hidden-xs col-sm-6">
												<div class="header-connection">
													<!-- Временное ограничение в связи с ненадобностью -->
													<!--
...
-->
						    	...
						    	<div class="col-md-4 col-xs-12 col-sm-6">
							    	<div class="service-item">
							    		...
							    		<div class="service-description">
							    			...
							    			<a href="/services/Сантехника">Цены</a>
							    		</div>
							    	</div>
						    	</div>
						    	<div class="col-md-4 col-xs-12 col-sm-6">
							    	<div class="service-item">
							    		...
							    		<div class="service-description">
							    			<h3>Электрика</h3>
							    			<p>Список не полный! Если вам нужна услуга, а в списке её нет. Оставьте заявку я обязательно свяжусь с Вами.</p>
							    			<a href="/services/Электрика">Цены</a>
							    		</div>
							    	</div>
						    	</div>
						    	<div class="col-md-4 col-xs-12 col-sm-6">
							    	<div class="service-item">
							    		...
							    		<div class="service-description">
							    			<h3>Установка и ремонт вентиляции</h3>
							    			<p>Список не полный! Если вам нужна услуга, а в списке её нет. Оставьте заявку я обязательно свяжусь с Вами.</p>
							    			<a href="/services/Установка и ремонт вентиляции">Цены</a>
							    		</div>
							    	</div>
						    	</div>
						    	<div class="col-md-4 col-xs-12 col-sm-6">
							    	<div class="service-item">
							    		...
							    		<div class="service-description">
							    			<h3>Ремонт и установка бытовой техники</h3>
							    			<p>Список не полный! Если вам нужна услуга, а в списке её нет. Оставьте заявку я обязательно свяжусь с Вами.</p>
							    			<a href="/services/Ремонт и установка бытовой техники">Цены</a>
							    		</div>
							    	</div>
						    	</div>
						    	<div class="col-md-4 col-xs-12 col-sm-6">
							    	<div class="service-item">
							    		...
							    		<div class="service-description">
							    			<h3>Ремонтно-строительные работы по дому</h3>
							    			<p>Список не полный! Если вам нужна услуга, а в списке её нет. Оставьте заявку я обязательно свяжусь с Вами.</p>
							    			<a href="/services/Ремонтно-строительные работы по дому">Цены</a>
							    		</div>
							    	</div>
						    	</div>
						    	<div class="col-md-4 col-xs-12 col-sm-6">
							    	<div class="service-item">
							    		...
							    		<div class="service-description">
							    			<h3>Услуги сварщика</h3>
							    			<p>Список не полный! Если вам нужна услуга, а в списке её нет. Оставьте заявку я обязательно свяжусь с Вами.</p>
							    			<a href="/services/Услуги сварщика">Цены</a>
							    		</div>
							    	</div>
						    	</div>
							</div>
					...
					<!-- .container-->
					<!-- Причина: В данный момент нет необходимости данного блока -->
					<!--
					<div class="container">
						<div class="row">
