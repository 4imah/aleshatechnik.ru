...
-->
							...
							<div class="row">
								<div class="col-md-12">
									<div class="page-title">
										...
										<ul class="breadcrumb">
										   <li><a href="/">Главная</a></li>
										   <li class="active">Свяаться со мной</li>
										</ul>
									</div>
								</div>
							</div>
					...
					<!-- .container-->
					<!-- В данный момент не надо так как не знаю js-->
					<!--
					<div class="map-area">
							...
							<div class="form-section">
								<div class="col-md-8 col-xs-12 col-sm-8">
									...
									<section>
										...
										<p>Если вы не нашли, то что искали, можете связаться со мной по контактам указанным справа или же оставьте заявку.</p>
										<form action="/contacts/send/" method="GET">
											<label>Услуга:</label><br>
											<select class="select" id="subject" name="service">
												...
												<option >Ремонтно-строительные работы по дому</option>									
												<option >Услуги сварщика</option>									
											</select><br><br>
											<input type="text" id="full-name" name="name" placeholder="Имя">
											<input type="text" id="email" name="mobile" placeholder="Телефон">
							...
							<div class="footer-top">
								...
								<div class="col-md-3 col-sm-6">
									<div class="contact-us">
										<h4>Contact us</h4>
										<address>
											77 Москва Город Город / Населенный пункт: Зеленоград
											3456 E. Wieding Road <br>Tucson AZ, 3456
										</address>
										<address>
										 	<span>Email :</span> 
